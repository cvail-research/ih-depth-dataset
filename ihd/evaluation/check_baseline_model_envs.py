...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--depthanythingv2-python", default="uv run --extra depthanythingv2 python")
    ap.add_argument("--depthpro-python", default="uv run --extra depthpro python")
