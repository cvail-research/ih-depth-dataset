...
Typical usage:
  python baselines/physics_based/run_bispectral.py --hsi-hdr <scene.hdr> --lidar-mat baselines/physics_based/data/lidar.mat
"""
...
from ihd.utils.baseline_io import save_depth_prediction
...
def parse_args() -> argparse.Namespace:
	...
	default_data = Path("baselines/physics_based/data")
	...
	p.add_argument("--data-dir", type=Path, default=default_data, help="Data directory (default: baselines/physics_based/data)")
	p.add_argument(
		"--attenuation-profile",
