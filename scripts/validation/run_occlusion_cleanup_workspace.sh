#!/bin/bash
#SBATCH --job-name=occlusion_cleanup_workspace
#SBATCH --output=logs/out/%j_occlusion_cleanup_workspace.out
#SBATCH --error=logs/err/%j_occlusion_cleanup_workspace.err
...
srun uv run python -m ihd.occlusion_cleanup.app \
